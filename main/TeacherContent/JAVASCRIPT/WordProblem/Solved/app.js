...
function Jessica (fruit) {
  let appleSpot = fruit.indexOf('apple')
  fruit.splice(appleSpot, 1)
  let grapesSpot = fruit.indexOf('grapes')
  fruit.splice(grapesSpot, 1)
  Anthony(fruit)
}
function Gene (fruit) {
  let tomatoSpot = fruit.indexOf('tomato')
  Desiree(fruit[tomatoSpot])
}

function Anthony (fruit) {
  console.log(`Anthony's Fruit : ${fruit}`)
}

function Desiree (fruit) {
  console.log(`Desiree's Fruit : ${fruit}`)
}
David()
